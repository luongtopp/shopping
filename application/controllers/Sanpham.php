...
class Sanpham extends CI_Controller {
    ...
    public function index(){
        ...
        $this->data['title']='Cường Thuận Store - Tất cả sản phẩm';
    ...
    public function category(){
        ...
        $this->data['title']='Cường Thuận Store - Sản phẩm theo từng danh mục';  
    ...
    public function detail($link){   
        ...
        $this->data['row']=$row;
        $this->data['title']='Cường Thuận Store - '.$row['name'];  
